...
public class BackGroundService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId){
        ...
        ArrayList<String> filePaths = (ArrayList<String>) extras.get("fileLocations");
        Log.e("Service", filePaths + "aa");
    ...
    private void createNotificationChannel() {
        // Create the NotificationChannel, supported only on API 26+ because the NotificationChannel class is new and not in the support library
